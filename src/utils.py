...
RESIDUES_MSKB = {
    ...
    "Y": 163.063329,
    "W": 186.079313,
    "O": 237.147727,  # https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3070376/
...
def get_token_dicts_mskb(amod_dict):
...
def get_ninespecies_HF_data_module(
    ...
    dataset_directory = os.path.join(
        global_args.downstream_root_dir, "parquet/processed"
    )
...
def configure_callbacks(
    ...
    if task_args.get("anneal_lr", False):
